...
const seedJson = JSON.stringify(seedBundle);
const htmlJson = JSON.stringify(htmlContent);
...
const codeParts = [
  ...
  '};',
  '',
  'const INDEX_HTML = ' + htmlJson + ';'
];

const fullWorkerCode = codeParts.join('\n');
fs.writeFileSync(workerPath, fullWorkerCode, 'utf8');

console.log('SUCCESS_WORKER_COMPILED: ' + (fullWorkerCode.length / 1024).toFixed(1) + ' KB');
process.exit(0);
