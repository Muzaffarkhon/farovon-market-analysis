...
router.post('/admin/user-capabilities', requireRoles('admin'), adminController.grantUserCapability);
router.post('/admin/user-capabilities/revoke', requireRoles('admin'), adminController.revokeUserCapability);
