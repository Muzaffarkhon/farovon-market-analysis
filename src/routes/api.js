...
router.post('/admin/grading-blocks/restore-evaluation', requireCapability('grading:blocks'), gradingController.restoreEvaluation);
...
router.get('/comp/hr-bp', requireCapability('comp:submit'), compReviewController.hrBpOptions);
